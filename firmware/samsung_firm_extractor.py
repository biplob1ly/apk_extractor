...
firm_apk_hash_path = "samsung_lata_apk_hash_path.txt"
firm_hash_file = "samsung_sys_hash.txt"
source_path_file = "samsung_lata_firm_paths.txt"
logger_file = "samsung_lata_extraction_log.txt"
firm_pos = "samsung_firm_pos.txt"
start = None
