...
firm_apk_hash_path = "batch3_apk_hash_path.txt"
firm_hash_file = "batch3_sys_hash.txt"
source_path_file = "batch3_firm_paths.txt"
logger_file = "batch3_extraction_log.txt"
firm_pos = "batch3_firm_pos.txt"
start = None
...
if __name__ == "__main__":
    ...
    for source_firm_path in firm_paths:
        try:
            ...
            manufacturer = source_firm_path.split(os.sep)[7]
            wd = manufacturer
            wd_path = wd + "/**/"
