...
firm_sys_hash_file = os.path.expanduser("~/Projects/apk_extractor/batch1_firm_sys_hash.txt")
log = "log starts here.\n"
start = None
apk_dict = {}
firm_cert_dict = {}
...
if __name__ == "__main__":
    ...
    if app_source == "play-store":
        ...
        apk_names_file = os.path.expanduser('~/Projects/apk_extractor/batch1_apk_hashes.txt')
